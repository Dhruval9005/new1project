...
const LoginInfo = ({ user }: any) => {
  ...
  return (
    <div className="logininfo  h-screen">
      ...
      <div className="container relative flex flex-col justify-center mt-10 overflow-hidden mx-auto">
        <div className="sm:w-96 w-full p-6 m-auto bg-white rounded-md shadow-lg my-3">
          <h1 className="md:text-2xl loginfont text-xl font-semibold   text-purple-700  ">
          Welcome Too  Tranx Account
          </h1>
          ...
          <div className="mt-6">
            <button
              // type="submit"
              onClick={sendData}
              className=" labal font-bold md:text-lg text-sm w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600"
            >
              Save
            </button>
          </div>
